...
function ParentsLogin() {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "userLogin") setUserLogin(value);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (userRole !== "Parents") {
        throw new Error(
          "Only parents can log in here. Please use the appropriate login page."
        );
      }
      ...
      // Enhance user with default img_profile
      const enhancedUser = {
        ...apiUser,
      ...
      console.error("Parents login error:", {
        message: err.message,
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-6 text-center">
            <h1 className="text-2xl font-bold text-white">Parents Portal</h1>
