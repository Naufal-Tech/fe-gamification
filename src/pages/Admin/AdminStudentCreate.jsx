...
function AdminStudentCreate() {
  ...
  const validateForm = () => {
    ...
    if (!formData.noIdentity) newErrors.noIdentity = "Student ID is required";
    else if (!/^\d+$/.test(formData.noIdentity))
      newErrors.noIdentity = "Student ID must contain only numbers";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post(
        ...
        {
          ...formData,
          role: "User", // Force User role for this form
          kelas: formData.classId, // Map classId to kelas field
        },
        {
          headers: {
      ...
      navigate("/admin/students", {
        state: { successMessage: "Student account created successfully" },
      });
    } catch (error) {
      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="relative bg-gradient-to-r from-indigo-600 to-blue-600 p-6 text-white">
          ...
          <div className="text-center pt-8 pb-4">
            ...
            <p className="mt-2 opacity-90">Add a new student to the system</p>
          </div>
        </div>
